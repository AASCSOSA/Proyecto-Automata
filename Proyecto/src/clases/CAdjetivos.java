...
public class CAdjetivos implements IAdjetivo {
    ...
    public String[] agregarAdjetivo() {
        String[] adjetivo = {
            ...
            "Alegres", "Tristes", "Inteligentes", "Creativos", "Valientes",
            "Divertidos", "Serios", "Amables", "Energéticos", "Pacientes",
            "Bellas", "Feos", "Grandes", "Pequeños", "Rápidos",
            "Lentos", "Fuertes", "Débiles", "Cálidos", "Fríos",
            "Felices", "Infelices", "Sabios", "Jóvenes", "Viejos",
            "Dulces", "Amargos", "Luminosos", "Oscuros", "Hermosos",
            "Feos", "Ruidosos", "Silenciosos", "Limpios", "Sucios",
            "Altos", "Bajos", "Anchos", "Estrechos", "Ricos",
            "Pobres", "Rápidos", "Lentos", "Duros", "Suaves",
            "Nuevos", "Viejos", "Buenos", "Malos", "Amorosos",
            "Odiosos", "Dulces", "Salados", "Brillantes", "Opacos",
            "Agradables", "Desagradables", "Saludables", "Enfermos", "Frescos",
            "Stale", "Ligeros", "Pesados", "Agradables", "Desagradables",
            "Elegantes", "Sencillos", "Húmedos", "Secos", "Puros",
            "Contaminados", "Lindos", "Feos", "Inocentes", "Culpables",
            "Altos", "Bajos", "Agradables", "Desagradables", "Afortunados",
            "Desafortunados", "Graciosos", "Serios", "Famosos", "Desconocidos",
            "Duros", "Suaves", "Tranquilos", "Ruidosos", "Difíciles",
            "Fáciles", "Antiguos", "Modernos", "Caros", "Baratos",
            "Largos", "Cortos", "Agradables", "Desagradables", "Gigantes",
            "Minúsculos", "Completos", "Incompletos", "Dulces", "Amargos", "Pequeños",
            "Curiosos", "Inquietos", "Valientes", "Juguetones", "Traviesos", "Listos", "Audaces",
            "Amigables", "Peludos", "Exploradores", "Astutos", "Alegres", "Hambrientos", "Ingeniosos",
            "Asustados", "Sorprendidos", "Encantados", "Animados", "Dormilones", "Azules", "Amarillas", "amarillos", "rojos",
            "azules", "naranjas", "rojos", "moradas", "cansados", "motivados", "morados", "violetas", "púrpuras", "Enormes", "Vanidosos", "Hermosos",
